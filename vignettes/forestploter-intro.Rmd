...
Or you can get the width and height of the forestplot with `get_wh`, and use this width and height for saving. You can also use get the optimal scale for desired width and height with `get_scale`.
