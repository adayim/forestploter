...
Sometimes one may want to change the color or font face of some columns. Or may want to add/insert text into certain rows. Or may want to add an underline to the row separate by group. The function `edit_plot`, `add_text`, `insert_text` and `add_underline` can achieve these. To note, the row index will change after inserting text. 
