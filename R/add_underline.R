...
#'
#' This function is a wrapper of \code{\link{add_border}} can be used to add
#' underline to cells.
#'
...
#' @seealso \code{\link[grid]{gpar}} \code{\link[grid]{segmentsGrob}} \code{\link[gtable]{gtable_add_grob}}  \code{\link{add_border}}
#' @export
#'
...
#' Add border to cells
#'
#' This function can be used to add border to cells.
#'
#' @param plot A forest plot object.
